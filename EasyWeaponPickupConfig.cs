...
namespace EasyWeaponPickup
{
    public class EasyWeaponPickupConfig //: AttributeGlobalSettings<EasyWeaponPickupConfig>
    {
        ...
        // NO MCM Singleton replacement
        private static EasyWeaponPickupConfig instance = null;

        private EasyWeaponPickupConfig()
        {
        }

        public static EasyWeaponPickupConfig Instance
        {
            get
            {
                if (instance == null)
                {
                    instance = new EasyWeaponPickupConfig();
                }
                return instance;
            }
        }
